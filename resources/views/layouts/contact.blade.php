...
@keyframes bi-cycle {
  ...
  @endif
                        <form class="form" name="enq" method="post" action="/src/contact" onsubmit="return validation();">
                            <div class="row">
...
@enderror
                                ...
                                <div class="form-group col-md-12">
                                    <textarea rows="6" name="message" class="form-control" placeholder="Pesan Anda">
                                    </textarea>
@error("message")
  <div class="text-danger">{{$message}}</div>
@enderror
